...
private:
    ...
    const OpcodeInfo opcodeTable[16][16] = {
        ...
        {{&CPU::BNE, &CPU::REL, "BNE", 2, 2}, {&CPU::CMP, &CPU::INDY, "CMP", 2, 5},{&CPU::XXX, &CPU::XXX, "JAM", 0, 0},{&CPU::DCP, &CPU::INDY, "DCP", 2, 8},{&CPU::NOP, &CPU::ZPGX, "NOP", 2, 4},{&CPU::CMP, &CPU::ZPGX, "CMP", 2, 4},{&CPU::DEC, &CPU::ZPGX, "DEC", 2, 6},{&CPU::DCP, &CPU::ZPGX, "DCP", 2, 6},{&CPU::CLD, &CPU::IMPL, "CLD", 1, 2},{&CPU::CMP, &CPU::ABSY, "CMP", 3, 4},{&CPU::NOP, &CPU::IMPL, "NOP", 1, 2},{&CPU::DCP, &CPU::ABSY, "DCP", 3, 7}, {&CPU::NOP, &CPU::ABSX, "NOP", 3, 4},{&CPU::CMP, &CPU::ABSX, "CMP", 3, 4},{&CPU::DEC, &CPU::ABSX, "DEC", 3, 7},{&CPU::DCP, &CPU::ABSX, "DCP", 3, 7}}, //D
